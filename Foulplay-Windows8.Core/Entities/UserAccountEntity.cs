...
namespace Foulplay_Windows8.Core.Entities
{
    public class UserAccountEntity
    {
        ...
        public UserAccountEntity()
        {
            object accessToken;
            object refreshToken;
            _localSettings.Values.TryGetValue("accessToken",  out accessToken);
            _localSettings.Values.TryGetValue("refreshToken", out refreshToken);
            this._data = new AccountData((string)accessToken, (string)refreshToken, 3600);
            this._entity = null;
